...
import { FaPhone, FaMapPin, FaMapMarkerAlt } from 'react-icons/fa';
                    ...
                    <div className="max-w-7xl md:flex w-full bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
                        ...
                        <div className="p-6 sm:p-8">
                            ...
                            <div className="space-y-4 bg-gray-50 p-4 rounded-lg shadow-sm border border-gray-200">
                                ...
                                <div className="flex justify-between items-center">
                                    <span className="font-medium text-gray-700 flex items-center gap-2">
                                        <FaEarthAsia /> Latitude:
                                    </span>
                                    <span className="text-gray-900">{data.latitude || "N/A"}</span>
                                </div>
                            </div>
                            <div className='text-right mt-6'>
                                <Link to={`/userlocation/${data.name}/${data.longitude}/${data.latitude}`} className="w-full bg-blue-500 text-white px-5 py-2 rounded hover:bg-blue-600 transition">
                                    Summary
                                </Link>
                            </div>
                        </div>
